...
/*  Created On : 22-sep.-2025 11:01:38 a. m. 				*/
...
(
	...
	[año] int NOT NULL,    -- Aquí se almacena el año de fabricación del vehículo externo. Debe ser un número entero de cuatro dígitos comprendido entre 1900 y el año actual, para garantizar la validez del dato. No puede quedar vacío.
...
ALTER TABLE [Tbl_VehiculoExterno] 
 ADD CONSTRAINT [CK_VehiculoExterno_Año] CHECK (año >= 1900 AND año <= YEAR(GETDATE()))
GO
...
EXEC sp_addextendedproperty 'MS_Description', 'Aquí se almacena el año de fabricación del vehículo externo. Debe ser un número entero de cuatro dígitos comprendido entre 1900 y el año actual, para garantizar la validez del dato. No puede quedar vacío.', 'Schema', [dbo], 'table', [Tbl_VehiculoExterno], 'column', [año]
GO
...
if exists (select * from ::fn_listextendedproperty ('MS_Description', 'SCHEMA', 'dbo', 'TABLE', 'Tbl_VehiculoExterno', 'CONSTRAINT', 'CK_VehiculoExterno_Año')) 
   begin 
 	EXEC sys.sp_updateextendedproperty 'MS_Description', 'Restringe año a =1900 y = año actual.', 'SCHEMA', 'dbo', 'TABLE', 'Tbl_VehiculoExterno', 'CONSTRAINT', 'CK_VehiculoExterno_Año' 
   end 
 else 
   begin 
 	EXEC sys.sp_addextendedproperty    'MS_Description', 'Restringe año a =1900 y = año actual.', 'SCHEMA', 'dbo', 'TABLE', 'Tbl_VehiculoExterno', 'CONSTRAINT', 'CK_VehiculoExterno_Año' 
   end 
