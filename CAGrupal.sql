...
/*  Created On : 22-sep.-2025 02:01:01 p. m. 				*/
...
ALTER TABLE [Tbl_VehiculoExterno] 
 ADD CONSTRAINT [CK_VehiculoExterno_Anio] CHECK (anioo >= 1900 AND anio <= YEAR(GETDATE()))
GO
...
GOif exists (select * from ::fn_listextendedproperty ('MS_Description', 'SCHEMA', 'dbo', 'table', 'Tbl_CitaServicio', NULL, NULL)) 
begin 
...
GOif exists (select * from ::fn_listextendedproperty ('MS_Description', 'SCHEMA', 'dbo', 'table', 'Tbl_Cliente', NULL, NULL)) 
begin 
...
GOif exists (select * from ::fn_listextendedproperty ('MS_Description', 'SCHEMA', 'dbo', 'table', 'Tbl_DetalleOrdenCompra', NULL, NULL)) 
begin 
...
GOif exists (select * from ::fn_listextendedproperty ('MS_Description', 'SCHEMA', 'dbo', 'table', 'Tbl_Empleado', NULL, NULL)) 
begin 
...
GOif exists (select * from ::fn_listextendedproperty ('MS_Description', 'SCHEMA', 'dbo', 'table', 'Tbl_Factura', NULL, NULL)) 
begin 
...
GOif exists (select * from ::fn_listextendedproperty ('MS_Description', 'SCHEMA', 'dbo', 'table', 'Tbl_OrdenCompra', NULL, NULL)) 
begin 
...
GOif exists (select * from ::fn_listextendedproperty ('MS_Description', 'SCHEMA', 'dbo', 'table', 'Tbl_Proveedor', NULL, NULL)) 
begin 
...
GOif exists (select * from ::fn_listextendedproperty ('MS_Description', 'SCHEMA', 'dbo', 'table', 'Tbl_Repuesto', NULL, NULL)) 
begin 
...
GOif exists (select * from ::fn_listextendedproperty ('MS_Description', 'SCHEMA', 'dbo', 'table', 'Tbl_Servicio', NULL, NULL)) 
begin 
...
GOif exists (select * from ::fn_listextendedproperty ('MS_Description', 'SCHEMA', 'dbo', 'table', 'Tbl_ServicioRealizado', NULL, NULL)) 
begin 
...
GOif exists (select * from ::fn_listextendedproperty ('MS_Description', 'SCHEMA', 'dbo', 'table', 'Tbl_Vehiculo', NULL, NULL)) 
begin 
...
GOif exists (select * from ::fn_listextendedproperty ('MS_Description', 'SCHEMA', 'dbo', 'table', 'Tbl_VehiculoExterno', NULL, NULL)) 
begin 
...
GOif exists (select * from ::fn_listextendedproperty ('MS_Description', 'SCHEMA', 'dbo', 'table', 'Tbl_Venta', NULL, NULL)) 
begin 
