...
/*  Created On : 22-sep.-2025 06:33:47 p. m. 				*/
...
(
	...
	[observaciones] varchar(255) NULL,    -- Aquí se almacenan comentarios adicionales relacionados con el servicio realizado (ejemplo: detalles del diagnóstico, recomendaciones al cliente). Es un campo opcional y puede quedar vacío.
...
(
	...
	[numero_chasis] varchar(50) NOT NULL,    -- Aquí se guarda el número de chasis único del vehículo. Es un valor de texto (hasta 50 caracteres) que identifica de manera exclusiva al vehículo. No puede quedar vacío ni repetirse en otro vehículo.
...
/* ================================
   INSERTS PARA Tbl_Cliente
   ================================ */
INSERT INTO Tbl_Cliente (id_cliente, email, nombre, apellido, telefono, direccion, ciudad, estado_cliente, codigo_postal, fecha_registro, tipo_cliente)
VALUES
(1001, 'juanperez@mail.com', 'Juan', 'Pérez', '8888-1111', 'Calle Central 123', 'Managua', 'Managua', '11001', '2023-05-01', 'Particular'),
(1002, 'mariagonzalez@mail.com', 'María', 'González', '8888-2222', 'Av. Bolívar 456', 'León', 'León', '21002', '2023-06-10', 'Particular'),
(1003, 'carlosruiz@mail.com', 'Carlos', 'Ruiz', '8888-3333', 'Col. Jardines 78', 'Granada', 'Granada', '33001', '2023-07-15', 'Empresa'),
(1004, 'ana.lopez@mail.com', 'Ana', 'López', '8888-4444', 'Barrio Centro 11', 'Masaya', 'Masaya', '44002', '2023-08-01', 'Particular'),
(1005, 'jose.martinez@mail.com', 'José', 'Martínez', '8888-5555', 'Km 5 Carretera Sur', 'Managua', 'Managua', '11005', '2023-09-10', 'Particular'),
(1006, 'camila.torres@mail.com', 'Camila', 'Torres', '8888-6666', 'Bo. San Judas 222', 'Estelí', 'Estelí', '55001', '2023-09-25', 'Particular'),
(1007, 'daniel.rojas@mail.com', 'Daniel', 'Rojas', '8888-7777', 'Calle 14 No. 45', 'Chinandega', 'Chinandega', '66003', '2023-10-02', 'Empresa'),
(1008, 'sofia.mendoza@mail.com', 'Sofía', 'Mendoza', '8888-8888', 'Residencial Vista', 'Matagalpa', 'Matagalpa', '77004', '2023-10-20', 'Particular'),
(1009, 'pedro.castillo@mail.com', 'Pedro', 'Castillo', '8888-9999', 'Av. Bolívar 567', 'Jinotega', 'Jinotega', '88001', '2023-11-01', 'Particular'),
(1010, 'valeria.fernandez@mail.com', 'Valeria', 'Fernández', '8899-0001', 'Reparto Universitario', 'Rivas', 'Rivas', '99002', '2023-11-15', 'Empresa'),
(1011, 'ricardo.mejia@mail.com', 'Ricardo', 'Mejía', '8899-0002', 'Col. Las Flores', 'Boaco', 'Boaco', '10103', '2023-11-20', 'Particular'),
(1012, 'isabel.morales@mail.com', 'Isabel', 'Morales', '8899-0003', 'Bo. La Luz', 'Carazo', 'Carazo', '10205', '2023-12-01', 'Particular');



/* ================================
   INSERTS PARA Tbl_Empleado
   ================================ */
INSERT INTO Tbl_Empleado (id_empleado, email, nombre, apellido, cargo, telefono, fecha_contratacion, salario, direccion, estado_empleado)
VALUES
(2001, 'carlos.vargas@nicamotores.com', 'Carlos', 'Vargas', 'Vendedor', '7777-1111', '2020-01-15', 500.00, 'Calle Central 123', 'Activo'),
(2002, 'laura.ramirez@nicamotores.com', 'Laura', 'Ramírez', 'Mecánico', '7777-2222', '2019-03-20', 600.00, 'Av. Central 234', 'Activo'),
(2003, 'miguel.sandoval@nicamotores.com', 'Miguel', 'Sandoval', 'Mecánico', '7777-3333', '2018-07-01', 620.00, 'Col. Jardines 456', 'Activo'),
(2004, 'andrea.rodriguez@nicamotores.com', 'Andrea', 'Rodríguez', 'Gerente', '7777-4444', '2015-09-12', 1200.00, 'Barrio Central 89', 'Activo'),
(2005, 'sofia.rivas@nicamotores.com', 'Sofía', 'Rivas', 'Vendedor', '7777-5555', '2021-11-05', 520.00, 'Col. Las Flores 12', 'Activo'),
(2006, 'javier.lopez@nicamotores.com', 'Javier', 'López', 'Mecánico', '7777-6666', '2017-06-30', 610.00, 'Bo. San Judas 90', 'Activo'),
(2007, 'camila.hernandez@nicamotores.com', 'Camila', 'Hernández', 'Vendedor', '7777-7777', '2022-01-01', 530.00, 'Col. Miraflores 56', 'Activo'),
(2008, 'fernando.martinez@nicamotores.com', 'Fernando', 'Martínez', 'Mecánico', '7777-8888', '2016-04-22', 615.00, 'Residencial Vista', 'Activo'),
(2009, 'paola.torres@nicamotores.com', 'Paola', 'Torres', 'Gerente', '7777-9999', '2014-12-01', 1250.00, 'Reparto Universitario', 'Activo'),
(2010, 'andres.mendoza@nicamotores.com', 'Andrés', 'Mendoza', 'Mecánico', '7788-0001', '2021-05-17', 605.00, 'Col. La Esperanza 34', 'Activo'),
(2011, 'valentina.gomez@nicamotores.com', 'Valentina', 'Gómez', 'Vendedor', '7788-0002', '2023-03-12', 540.00, 'Bo. La Luz 45', 'Activo'),
(2012, 'sebastian.rios@nicamotores.com', 'Sebastián', 'Ríos', 'Mecánico', '7788-0003', '2019-09-08', 610.00, 'Calle 9 No. 78', 'Activo');



/* ================================
   INSERTS PARA Tbl_Proveedor
   ================================ */
INSERT INTO Tbl_Proveedor (id_proveedor, nombre, telefono, email, direccion, ciudad, estado_proveedor, codigo_postal, contacto_principal, fecha_registro, tipo_proveedor)
VALUES
(3001, 'AutoRepuestos S.A.', '6666-1111', 'contacto@autorepuestos.com', 'Av. Bolívar 100', 'Managua', 'Managua', '11010', 'Luis Castillo', '2022-05-01', 'Local'),
(3002, 'MotoresGlobal', '6666-2222', 'ventas@motoresglobal.com', 'Km 12 Carretera Masaya', 'Masaya', 'Masaya', '22020', 'Carlos Ruiz', '2022-06-15', 'Internacional'),
(3003, 'Suspensiones Nicas', '6666-3333', 'info@suspensionesnicas.com', 'Col. Jardines 89', 'León', 'León', '33030', 'Ana López', '2022-07-10', 'Local'),
(3004, 'ElectroCar Parts', '6666-4444', 'ventas@electrocar.com', 'Zona Franca 12', 'Granada', 'Granada', '44040', 'María González', '2022-08-01', 'Internacional'),
(3005, 'Neumáticos del Norte', '6666-5555', 'contacto@neumaticosnorte.com', 'Km 7 Carretera Norte', 'Estelí', 'Estelí', '55050', 'José Martínez', '2022-09-20', 'Local'),
(3006, 'Lubricantes S.A.', '6666-6666', 'ventas@lubricantes.com', 'Bo. San Juan 345', 'Matagalpa', 'Matagalpa', '66060', 'Camila Torres', '2022-10-02', 'Local'),
(3007, 'Transmisiones y Más', '6666-7777', 'info@transmisionesymas.com', 'Zona Industrial 45', 'Jinotega', 'Jinotega', '77070', 'Ricardo Mejía', '2022-11-01', 'Internacional'),
(3008, 'Frenos Express', '6666-8888', 'ventas@frenosexpress.com', 'Av. Central 78', 'Rivas', 'Rivas', '88080', 'Pedro Castillo', '2022-11-15', 'Local'),
(3009, 'Carrocerías del Pacífico', '6666-9999', 'contacto@carroceriaspacifico.com', 'Carretera Vieja León', 'Boaco', 'Boaco', '99090', 'Daniel Rojas', '2022-12-01', 'Local'),
(3010, 'Global Auto Supply', '6677-0001', 'ventas@globalautosupply.com', 'Zona Franca 9', 'Carazo', 'Carazo', '10100', 'Sofía Mendoza', '2022-12-15', 'Internacional'),
(3011, 'Repuestos Nacionales', '6677-0002', 'info@repuestosnacionales.com', 'Barrio Universitario 67', 'Managua', 'Managua', '10200', 'Valeria Fernández', '2023-01-05', 'Local'),
(3012, 'Motores y Piezas Premium', '6677-0003', 'contacto@motorespremium.com', 'Km 5 Carretera Sur', 'Masaya', 'Masaya', '10300', 'Isabel Morales', '2023-01-20', 'Internacional');

/* ================================
   INSERTS PARA Tbl_Vehiculo
   ================================ */
INSERT INTO Tbl_Vehiculo (id_vehiculo, numero_chasis, marca, modelo, anio, color, tipo_combustible, tipo_transmision, precio, estado_vehiculo, fecha_ingreso, kilometraje)
VALUES
(4001, 'CHS12345678900001', 'Toyota', 'Corolla', '2022', 'Blanco', 'Gasolina', 'Automático', 18000.00, 'Disponible', '2023-01-10', 0),
(4002, 'CHS12345678900002', 'Honda', 'Civic', '2021', 'Negro', 'Gasolina', 'Mecánico', 17500.00, 'Disponible', '2023-01-20', 10),
(4003, 'CHS12345678900003', 'Nissan', 'Frontier', '2020', 'Gris', 'Diesel', 'Mecánico', 28000.00, 'Disponible', '2023-02-01', 50),
(4004, 'CHS12345678900004', 'Hyundai', 'Elantra', '2022', 'Rojo', 'Gasolina', 'Automático', 19000.00, 'Disponible', '2023-02-15', 0),
(4005, 'CHS12345678900005', 'Kia', 'Sportage', '2021', 'Azul', 'Gasolina', 'Automático', 25000.00, 'Disponible', '2023-03-01', 20),
(4006, 'CHS12345678900006', 'Chevrolet', 'Spark', '2019', 'Amarillo', 'Gasolina', 'Mecánico', 9000.00, 'Disponible', '2023-03-10', 100),
(4007, 'CHS12345678900007', 'Ford', 'Ranger', '2020', 'Verde', 'Diesel', 'Automático', 32000.00, 'Disponible', '2023-03-20', 30),
(4008, 'CHS12345678900008', 'Mazda', 'CX-5', '2022', 'Plateado', 'Gasolina', 'Automático', 27000.00, 'Disponible', '2023-04-01', 5),
(4009, 'CHS12345678900009', 'Volkswagen', 'Jetta', '2021', 'Blanco', 'Gasolina', 'Mecánico', 22000.00, 'Disponible', '2023-04-15', 15),
(4010, 'CHS12345678900010', 'BMW', 'X3', '2022', 'Negro', 'Gasolina', 'Automático', 45000.00, 'Disponible', '2023-05-01', 0),
(4011, 'CHS12345678900011', 'Audi', 'A4', '2021', 'Gris', 'Gasolina', 'Automático', 40000.00, 'Disponible', '2023-05-15', 5),
(4012, 'CHS12345678900012', 'Mercedes', 'C200', '2022', 'Azul', 'Gasolina', 'Automático', 48000.00, 'Disponible', '2023-06-01', 0);



/* ================================
   INSERTS PARA Tbl_VehiculoExterno
   ================================ */
INSERT INTO Tbl_VehiculoExterno (id_vehiculo_externo, placa, marca, modelo, anio, color, propietario)
VALUES
(5001, 'M123456', 'Toyota', 'Hilux', 2018, 'Blanco', 'Luis Pérez'),
(5002, 'M654321', 'Honda', 'CRV', 2019, 'Negro', 'Ana Ramírez'),
(5003, 'M789123', 'Nissan', 'Versa', 2020, 'Rojo', 'Carlos Gómez'),
(5004, 'M321987', 'Hyundai', 'Santa Fe', 2017, 'Azul', 'María Torres'),
(5005, 'M456789', 'Kia', 'Rio', 2016, 'Gris', 'José Martínez'),
(5006, 'M987654', 'Chevrolet', 'Aveo', 2015, 'Amarillo', 'Camila López'),
(5007, 'M852963', 'Ford', 'Escape', 2018, 'Plateado', 'Fernando Rojas'),
(5008, 'M369258', 'Mazda', '3', 2020, 'Verde', 'Isabel Morales'),
(5009, 'M147258', 'Volkswagen', 'Polo', 2017, 'Blanco', 'Ricardo Mendoza'),
(5010, 'M258147', 'BMW', 'X1', 2019, 'Negro', 'Sofía Hernández'),
(5011, 'M159357', 'Audi', 'Q3', 2020, 'Gris', 'Pedro Fernández'),
(5012, 'M753951', 'Mercedes', 'GLA', 2021, 'Rojo', 'Valeria Castillo');



/* ================================
   INSERTS PARA Tbl_Servicio
   ================================ */
INSERT INTO Tbl_Servicio (id_servicio, nombre, descripcion, costo, duracion_horas, garantia_meses, requiere_repuesto, nivel_dificultad, fecha_creacion, observaciones)
VALUES
(6001, 'Cambio de Aceite', 'Cambio de aceite de motor y filtro', 30.00, 1, 0, 'Sí', 'Básico', '2022-01-10', 'Incluye revisión rápida'),
(6002, 'Alineación y Balanceo', 'Ajuste de ángulos de llantas y balanceo de ruedas', 50.00, 2, 0, 'No', 'Medio', '2022-01-15', 'Se recomienda cada 10,000 km'),
(6003, 'Revisión General', 'Chequeo completo de mecánica y fluidos', 80.00, 3, 0, 'No', 'Medio', '2022-02-01', 'Revisión preventiva'),
(6004, 'Cambio de Frenos', 'Reemplazo de pastillas y revisión de discos', 120.00, 3, 6, 'Sí', 'Medio', '2022-02-20', 'Incluye purgado de frenos'),
(6005, 'Cambio de Batería', 'Instalación de batería nueva', 100.00, 1, 12, 'Sí', 'Básico', '2022-03-01', 'Garantía de fábrica incluida'),
(6006, 'Reparación Motor', 'Reparación parcial de motor', 500.00, 12, 3, 'Sí', 'Avanzado', '2022-03-10', 'Dependiendo del diagnóstico'),
(6007, 'Reparación Caja', 'Reparación de transmisión', 700.00, 16, 6, 'Sí', 'Avanzado', '2022-04-01', 'Trabajo especializado'),
(6008, 'Cambio de Amortiguadores', 'Reemplazo de amortiguadores delanteros y traseros', 200.00, 4, 12, 'Sí', 'Medio', '2022-04-15', 'Incluye alineación'),
(6009, 'Revisión Eléctrica', 'Chequeo del sistema eléctrico completo', 150.00, 4, 0, 'No', 'Avanzado', '2022-05-01', 'Incluye alternador y batería'),
(6010, 'Cambio de Llantas', 'Reemplazo de juego completo de llantas', 400.00, 2, 24, 'Sí', 'Básico', '2022-05-20', 'Depende de la marca de llanta'),
(6011, 'Lavado Completo', 'Lavado exterior e interior detallado', 25.00, 1, 0, 'No', 'Básico', '2022-06-01', 'Incluye encerado básico'),
(6012, 'Pulido y Encerado', 'Servicio estético de pulido y encerado profesional', 150.00, 3, 0, 'No', 'Medio', '2022-06-10', 'Recomendado cada 6 meses');

/* ================================
   INSERTS PARA Tbl_Venta
   ================================ */
INSERT INTO Tbl_Venta (id_venta, id_vehiculo, id_cliente, id_empleado, fecha_venta, precio_venta, forma_pago, estado_pago, observaciones)
VALUES
(7001, 4001, 1001, 2001, '2023-01-15', 18000.00, 'Contado', 'Pagado', 'Venta cerrada sin incidencias'),
(7002, 4002, 1002, 2002, '2023-01-20', 17500.00, 'Crédito', 'Pendiente', 'Cliente financió el 50%'),
(7003, 4003, 1003, 2003, '2023-02-01', 28000.00, 'Contado', 'Pagado', 'Incluye accesorios adicionales'),
(7004, 4004, 1004, 2004, '2023-02-10', 19000.00, 'Crédito', 'Pendiente', 'Pago diferido a 24 meses'),
(7005, 4005, 1005, 2005, '2023-02-15', 25000.00, 'Contado', 'Pagado', 'Cliente habitual, descuento aplicado'),
(7006, 4006, 1006, 2006, '2023-03-01', 9000.00, 'Contado', 'Pagado', 'Vehículo de ocasión'),
(7007, 4007, 1007, 2007, '2023-03-10', 32000.00, 'Crédito', 'Pendiente', 'Cliente solicitó accesorios'),
(7008, 4008, 1008, 2008, '2023-03-20', 27000.00, 'Contado', 'Pagado', 'Se entregó con kit de emergencia'),
(7009, 4009, 1009, 2009, '2023-04-01', 22000.00, 'Crédito', 'Pendiente', 'Financiamiento a 12 meses'),
(7010, 4010, 1010, 2010, '2023-04-10', 45000.00, 'Contado', 'Pagado', 'Cliente corporativo'),
(7011, 4011, 1011, 2011, '2023-04-20', 40000.00, 'Contado', 'Pagado', 'Incluye mantenimiento gratis por 1 año'),
(7012, 4012, 1012, 2012, '2023-05-01', 48000.00, 'Crédito', 'Pendiente', 'Plan de pagos en 36 meses');


/* ================================
   INSERTS PARA Tbl_Factura
   ================================ */
INSERT INTO Tbl_Factura (id_factura, id_venta, fecha_emision, monto_total, estado_pago, metodo_pago, numero_recibo, fecha_vencimiento, id_empleado, observaciones)
VALUES
(8001, 7001, '2023-01-15', 18000.00, 'Pagado', 'Efectivo', 'R-001', '2023-01-15', 2001, 'Factura cancelada al contado'),
(8002, 7002, '2023-01-20', 17500.00, 'Pendiente', NULL, NULL, '2023-02-20', 2002, 'Factura pendiente de pago'),
(8003, 7003, '2023-02-01', 28000.00, 'Pagado', 'Tarjeta', 'R-002', '2023-02-01', 2003, 'Factura liquidada'),
(8004, 7004, '2023-02-10', 19000.00, 'Pendiente', NULL, NULL, '2023-03-10', 2004, 'Factura en financiamiento'),
(8005, 7005, '2023-02-15', 25000.00, 'Pagado', 'Tarjeta', 'R-003', '2023-02-15', 2005, 'Cliente con descuento'),
(8006, 7006, '2023-03-01', 9000.00, 'Pagado', 'Efectivo', 'R-004', '2023-03-01', 2006, 'Vehículo usado cancelado'),
(8007, 7007, '2023-03-10', 32000.00, 'Pendiente', NULL, NULL, '2023-04-10', 2007, 'Pendiente de pago'),
(8008, 7008, '2023-03-20', 27000.00, 'Pagado', 'Tarjeta', 'R-005', '2023-03-20', 2008, 'Incluye kit adicional'),
(8009, 7009, '2023-04-01', 22000.00, 'Pendiente', NULL, NULL, '2023-05-01', 2009, 'Pendiente por financiamiento'),
(8010, 7010, '2023-04-10', 45000.00, 'Pagado', 'Efectivo', 'R-006', '2023-04-10', 2010, 'Venta corporativa'),
(8011, 7011, '2023-04-20', 40000.00, 'Pagado', 'Tarjeta', 'R-007', '2023-04-20', 2011, 'Factura cancelada'),
(8012, 7012, '2023-05-01', 48000.00, 'Pendiente', NULL, NULL, '2023-06-01', 2012, 'Plan de pagos vigente');


/* ================================
   INSERTS PARA Tbl_OrdenCompra
   ================================ */
INSERT INTO Tbl_OrdenCompra (id_orden_compra, id_proveedor, fecha_orden, fecha_entrega, estado_orden, total_orden, observaciones, id_empleado, metodo_pago, forma_envio)
VALUES
(9001, 3001, '2023-01-05', '2023-01-15', 'Recibida', 5000.00, 'Compra inicial de stock', 2001, 'Efectivo', 'Terrestre'),
(9002, 3002, '2023-01-10', '2023-01-25', 'Pendiente', 8000.00, 'Pendiente de entrega', 2002, 'Transferencia', 'Marítimo'),
(9003, 3003, '2023-01-20', '2023-02-01', 'Recibida', 6000.00, 'Stock de emergencia', 2003, 'Efectivo', 'Aéreo'),
(9004, 3004, '2023-02-01', '2023-02-15', 'Recibida', 12000.00, 'Reposición general', 2004, 'Transferencia', 'Terrestre'),
(9005, 3005, '2023-02-10', '2023-02-25', 'Pendiente', 7000.00, 'Proveedor internacional', 2005, 'Efectivo', 'Marítimo'),
(9006, 3006, '2023-02-20', '2023-03-05', 'Recibida', 9500.00, 'Pedido urgente', 2006, 'Transferencia', 'Aéreo'),
(9007, 3007, '2023-03-01', '2023-03-20', 'Recibida', 4000.00, 'Orden complementaria', 2007, 'Efectivo', 'Terrestre'),
(9008, 3008, '2023-03-10', '2023-03-25', 'Pendiente', 15000.00, 'Compra mayorista', 2008, 'Transferencia', 'Marítimo'),
(9009, 3009, '2023-03-20', '2023-04-01', 'Recibida', 11000.00, 'Repuestos eléctricos', 2009, 'Efectivo', 'Terrestre'),
(9010, 3010, '2023-04-01', '2023-04-15', 'Pendiente', 20000.00, 'Proveedor premium', 2010, 'Transferencia', 'Aéreo'),
(9011, 3011, '2023-04-10', '2023-04-25', 'Recibida', 7500.00, 'Compra regional', 2011, 'Efectivo', 'Terrestre'),
(9012, 3012, '2023-04-20', '2023-05-05', 'Pendiente', 9500.00, 'Entrega en curso', 2012, 'Transferencia', 'Marítimo');

/* ================================
   INSERTS PARA Tbl_DetalleOrdenCompra
   ================================ */
INSERT INTO Tbl_DetalleOrdenCompra (id_detalle_orden_compra, id_orden_compra, id_repuesto, cantidad, precio_unitario, subtotal)
VALUES
(10001, 9001, 5001, 10, 50.00, 500.00),
(10002, 9002, 5002, 20, 80.00, 1600.00),
(10003, 9003, 5003, 15, 120.00, 1800.00),
(10004, 9004, 5004, 8, 200.00, 1600.00),
(10005, 9005, 5005, 12, 150.00, 1800.00),
(10006, 9006, 5006, 25, 40.00, 1000.00),
(10007, 9007, 5007, 30, 30.00, 900.00),
(10008, 9008, 5008, 10, 500.00, 5000.00),
(10009, 9009, 5009, 5, 700.00, 3500.00),
(10010, 9010, 5010, 7, 250.00, 1750.00),
(10011, 9011, 5011, 9, 90.00, 810.00),
(10012, 9012, 5012, 14, 60.00, 840.00);


/* ================================
   INSERTS PARA Tbl_Repuesto
   ================================ */
INSERT INTO Tbl_Repuesto (id_vehiculorepuesto, codigo_repuesto, nombre, descripcion, precio_unitario, stock, id_proveedor, fecha_ingreso, ubicacion_almacen, categoria, estado_repuesto)
VALUES
(5001, 'REP-001', 'Filtro de Aceite', 'Filtro estándar para motor', 50.00, 100, 3001, '2023-01-10', 'A1', 'Motor', 'Disponible'),
(5002, 'REP-002', 'Batería 12V', 'Batería de arranque 12 voltios', 80.00, 50, 3002, '2023-01-12', 'B2', 'Eléctrico', 'Disponible'),
(5003, 'REP-003', 'Pastillas de Freno', 'Juego delantero de pastillas', 120.00, 70, 3003, '2023-01-15', 'C3', 'Carrocería', 'Disponible'),
(5004, 'REP-004', 'Amortiguador', 'Amortiguador trasero hidráulico', 200.00, 30, 3004, '2023-01-18', 'D4', 'Suspensión', 'Disponible'),
(5005, 'REP-005', 'Radiador', 'Radiador de aluminio', 150.00, 25, 3005, '2023-01-20', 'E5', 'Motor', 'Disponible'),
(5006, 'REP-006', 'Bujías', 'Paquete de 4 bujías', 40.00, 200, 3006, '2023-01-22', 'F6', 'Motor', 'Disponible'),
(5007, 'REP-007', 'Filtro de Aire', 'Filtro estándar de aire', 30.00, 150, 3007, '2023-01-25', 'G7', 'Motor', 'Disponible'),
(5008, 'REP-008', 'Clutch', 'Kit completo de clutch', 500.00, 10, 3008, '2023-01-28', 'H8', 'Suspensión', 'Disponible'),
(5009, 'REP-009', 'Alternador', 'Alternador 12V 120A', 700.00, 8, 3009, '2023-02-01', 'I9', 'Eléctrico', 'Disponible'),
(5010, 'REP-010', 'Inyector', 'Inyector de combustible', 250.00, 12, 3010, '2023-02-05', 'J10', 'Motor', 'Disponible'),
(5011, 'REP-011', 'Espejo Retrovisor', 'Juego de espejos laterales', 90.00, 40, 3011, '2023-02-08', 'K11', 'Carrocería', 'Disponible'),
(5012, 'REP-012', 'Correa de Distribución', 'Correa dentada reforzada', 60.00, 60, 3012, '2023-02-10', 'L12', 'Motor', 'Disponible');


/* ================================
   INSERTS PARA Tbl_CitaServicio
   ================================ */
INSERT INTO Tbl_CitaServicio (id_cita, id_cliente, id_vehiculo, id_vehiculo_externo, id_servicio, fecha_cita, hora_cita, estado)
VALUES
(13001, 1001, 4001, NULL, 6001, '2026-01-15', '09:00:00', 'Atendida'),
(13002, 1002, NULL, 5002, 6002, '2026-01-20', '10:00:00', 'Atendida'),
(13003, 1003, 4003, NULL, 6003, '2026-01-25', '11:00:00', 'Atendida'),
(13004, 1004, 4004, NULL, 6004, '2026-02-01', '12:00:00', 'Atendida'),
(13005, 1005, NULL, 5005, 6005, '2026-02-10', '09:30:00', 'Pendiente'),
(13006, 1006, 4006, NULL, 6006, '2026-02-15', '10:30:00', 'Atendida'),
(13007, 1007, 4007, NULL, 6007, '2026-02-20', '11:30:00', 'Atendida'),
(13008, 1008, NULL, 5008, 6008, '2026-02-25', '12:30:00', 'Atendida'),
(13009, 1009, 4009, NULL, 6009, '2026-03-01', '09:00:00', 'Pendiente'),
(13010, 1010, 4010, NULL, 6010, '2026-03-05', '10:00:00', 'Atendida'),
(13011, 1011, 4011, NULL, 6011, '2026-03-10', '11:00:00', 'Atendida'),
(13012, 1012, NULL, 5012, 6012, '2026-03-15', '12:00:00', 'Pendiente');


/* ================================
   INSERTS PARA Tbl_ServicioRealizado
   ================================ */
INSERT INTO Tbl_ServicioRealizado (id_servicio_realizado, id_empleado, fecha_servicio, id_repuesto, cantidad_repuesto, costo_total, estado_servicio, observaciones, id_cita)
VALUES
(11001, 2001, '2023-01-15', 5001, 1, 80.00, 'Finalizado', 'Cambio de filtro aceite', 13001),
(11002, 2002, '2023-01-20', 5002, 1, 100.00, 'Finalizado', 'Cambio batería', 13002),
(11003, 2003, '2023-01-25', 5003, 1, 180.00, 'Finalizado', 'Cambio pastillas freno', 13003),
(11004, 2004, '2023-02-01', 5004, 2, 500.00, 'Finalizado', 'Cambio amortiguadores', 13004),
(11005, 2005, '2023-02-10', 5005, 1, 250.00, 'Pendiente', 'Radiador en espera', 13005),
(11006, 2006, '2023-02-15', 5006, 4, 160.00, 'Finalizado', 'Cambio bujías', 13006),
(11007, 2007, '2023-02-20', 5007, 1, 90.00, 'Finalizado', 'Cambio filtro aire', 13007),
(11008, 2008, '2023-02-25', 5008, 1, 700.00, 'Finalizado', 'Cambio clutch', 13008),
(11009, 2009, '2023-03-01', 5009, 1, 1000.00, 'Pendiente', 'Alternador no entregado', 13009),
(11010, 2010, '2023-03-05', 5010, 4, 1200.00, 'Finalizado', 'Cambio inyectores', 13010),
(11011, 2011, '2023-03-10', 5011, 2, 200.00, 'Finalizado', 'Cambio espejos', 13011),
(11012, 2012, '2023-03-15', 5012, 1, 150.00, 'Finalizado', 'Cambio correa', 13012);